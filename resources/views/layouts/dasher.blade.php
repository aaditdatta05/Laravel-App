...
<meta content="Codescandy" name="author">
  ...
  <link rel="stylesheet" href="{{ asset('dasher/assets') }}/libs/swiper/swiper-bundle.min.css" />
  <!-- Favicon icon-->
<link rel="apple-touch-icon" sizes="57x57" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-57x57.png" />
<link rel="apple-touch-icon" sizes="60x60" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-60x60.png" />
<link rel="apple-touch-icon" sizes="72x72" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-72x72.png" />
<link rel="apple-touch-icon" sizes="76x76" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-76x76.png" />
<link rel="apple-touch-icon" sizes="114x114" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-114x114.png" />
<link rel="apple-touch-icon" sizes="120x120" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-120x120.png" />
<link rel="apple-touch-icon" sizes="144x144" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-144x144.png" />
<link rel="apple-touch-icon" sizes="152x152" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-152x152.png" />
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('dasher/assets') }}/images/favicon/apple-icon-180x180.png" />
<link rel="icon" type="image/png" sizes="192x192" href="{{ asset('dasher/assets') }}/images/favicon/android-icon-192x192.png" />
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('dasher/assets') }}/images/favicon/favicon-32x32.png" />
<link rel="icon" type="image/png" sizes="96x96" href="{{ asset('dasher/assets') }}/images/favicon/favicon-96x96.png" />
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('dasher/assets') }}/images/favicon/favicon-16x16.png" />

<meta name="msapplication-TileColor" content="#ffffff" />
<meta name="msapplication-TileImage" content="{{ asset('dasher/assets') }}/images/favicon/ms-icon-144x144.png" />
<meta name="theme-color" content="#ffffff" />
<!-- Color modes -->
<script src="{{ asset('dasher/assets') }}/js/vendors/color-modes.js"></script>
<script>
...
<link rel="stylesheet" href="{{ asset('dasher/assets') }}/libs/simplebar/dist/simplebar.min.css" />
<link rel="stylesheet" href="{{ asset('dasher/assets') }}/libs/@tabler/icons-webfont/tabler-icons.min.css" />

<!-- Theme CSS -->
<link rel="stylesheet" href="{{ asset('dasher/assets') }}/css/theme.min.css">
...
<body>
  ...
  <div class="brand-logo">
    <a class="d-none d-md-flex align-items-center gap-2" href="./index.html">
      <img src="{{ asset('dasher/assets') }}/images/brand/logo/logo-icon.svg" alt="" />
  ...
  <ul class="navbar-nav flex-column  ">
    ...
    <li>
      <div class="text-center py-5 upgrade-ui ">
        <div>
          <img src="{{ asset('dasher/assets') }}/images/avatar/avatar-1.jpg" alt="" class="avatar avatar-md rounded-circle">
          <div class="my-3">
    ...
    <ul class="navbar-nav flex-column  ">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./apps/e-commerce/ecommerce-products-details.html">Product Detail</a>
          </li>
          <li class="nav-item">
    ...
    <ul class="list-unstyled d-flex align-items-center mb-0 gap-2">
      ...
      <li class="ms-3 dropdown">
        <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="{{ asset('dasher/assets') }}/images/avatar/avatar-1.jpg" alt="" class="avatar avatar-sm rounded-circle" />
        </a>
      ...
      <div data-simplebar="" style="height: 800px">
        <div class="list-group list-group-flush">
          ...
          <a href="#" class="list-group-item list-group-item-action p-5 border-dashed border-bottom">
            <div class="d-flex justify-content-between">
              <div class="d-flex gap-4 align-items-center">
                <img src="{{ asset('dasher/assets') }}/images/avatar/avatar-2.jpg" alt="" class="avatar avatar-md rounded-circle" />
                <div class="d-flex flex-column gap-1">
          ...
          <a href="#" class="list-group-item list-group-item-action p-5 border-dashed border-bottom">
            <div class="d-flex justify-content-between">
              <div class="d-flex gap-4 align-items-center">
                <img src="{{ asset('dasher/assets') }}/images/avatar/avatar-3.jpg" alt="" class="avatar avatar-md rounded-circle" />
                <div class="d-flex flex-column gap-1">
...
<div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
  ...
  <!-- Libs JS -->
<script src="{{ asset('dasher/assets') }}/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
<script src="{{ asset('dasher/assets') }}/libs/simplebar/dist/simplebar.min.js"></script>

<!-- Theme JS -->
<script src="{{ asset('dasher/assets') }}/js/theme.min.js"></script>
...
<head>
  ...
  <!-- jsvectormap -->
  <script src="{{ asset('dasher/assets') }}/js/vendors/sidebarnav.js"></script>
  <script src="{{ asset('dasher/assets') }}/libs/jsvectormap/dist/js/jsvectormap.min.js"></script>
  <script src="{{ asset('dasher/assets') }}/libs/jsvectormap/dist/maps/world.js"></script>
  <script src="{{ asset('dasher/assets') }}/libs/jsvectormap/dist/maps/world-merc.js"></script>
  <script src="{{ asset('dasher/assets') }}/libs/apexcharts/dist/apexcharts.min.js"></script>
  <script src="{{ asset('dasher/assets') }}/js/vendors/chart.js"></script>
  <script src="{{ asset('dasher/assets') }}/libs/choices.js/public/assets/scripts/choices.min.js"></script>
  <script src="{{ asset('dasher/assets') }}/js/vendors/choice.js"></script>
